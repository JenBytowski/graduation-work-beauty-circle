...
import {PriceListItemReq} from "../../../../../bc-common/src/lib/api-client/master-list/clients";
...
export class UpdateMasterComponent implements OnInit {
  ...
  public updateMasterInfo(): void {
    const id = this.route.snapshot.paramMap.get('id');//TODO: add jwt-decode
    this.masterList.updateMaster(id, MasterListClient.UpdateMasterReq.fromJS({
      ...
      instagramProfile: (this.instagramProfile as any).el.value | this.vm.Master.instagramProfile,
      vkProfile: (this.vkProfile as any).el.value | this.vm.Master.vkProfile,
