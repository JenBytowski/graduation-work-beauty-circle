...
{
  public class RocketSMSClient : AuthenticationService.ISMSClient, ISMSClient
  {
    ...
    public async Task SendSMS(AuthenticationService.SMS sms)
    {
      ...
      {
        var exception = new AuthenticationService.CantSendSMSException("Cant send sms by RocketSMS");
